...
import { createProducto, showProducto, showIdProducto, updateProducto, deleteProducto, obtenerProductos, obtenerTopProductos, obtenerEstadisticasInventario } from "../controller/Producto.controller.js";
...
router.post('/producto', verifyToken, checkBlacklist, authorizeRole('SuperAdmin','Administrador'), validateMiddleware(productoScheme.createProducto), createProducto);
...
router.put('/producto/:id', verifyToken, checkBlacklist, authorizeRole('SuperAdmin','Administrador','Cliente'), validateMiddleware(productoScheme.updateProducto), updateProducto);

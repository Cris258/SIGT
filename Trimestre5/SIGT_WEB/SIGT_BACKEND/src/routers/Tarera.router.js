...
import { createTarea, showTarea, showIdTarea, updateTarea, deleteTarea, getEstadisticas, getTopEmpleados, getEmpleadosTareas, getTareasByEmpleado, updateEstadoTarea } from "../controller/Tarea.controller.js";
...
router.put('/tarea/:id', verifyToken, checkBlacklist, authorizeRole('SuperAdmin','Administrador'), validateMiddleware(tareaScheme.updateTarea), updateTarea);

...
export default function AdminClientesPage() {
  ...
  const cargarDatos = async () => {
    try {
      ...
      // Cargar clientes con sus compras
      const resClientes = await axios.get(
        `${API_URL}/clientes-compras`,
        config
      );
  ...
  // Función para calcular el nivel del cliente
  const getNivelCliente = (compras) => {
    ...
    if (compras >= 5)
      return { nivel: "Premium", clase: "bg-info", icono: "bi-gem" };
      ...
      <div className="d-flex flex-column text-white flex-md-row">
        ...
        >
          ...
          <ul className="nav flex-column text-center text-white">
            ...
            <li className="nav-item">
              <a href="AdminCliente" className="nav-link custom-link active">
                Clientes
              </a>
            </li>
            <hr className="bg-light" />
            <li className="nav-item">
              <a href="ListarClientes" className="nav-link custom-link">
                Administrar Clientes
              </a>
            </li>
            <li className="nav-item">
              <a href="ListarCarritos" className="nav-link custom-link">
                Administrar Carritos
              </a>
            </li>
            <li className="nav-item">
              <a href="ListarVentas" className="nav-link custom-link">
                Administrar Ventas
              </a>
            </li>
          </ul>
